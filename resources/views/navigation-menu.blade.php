                        ...
                        <x-jet-dropdown>
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2  border-transparent text-sm font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                        Opciones
                            ...
                            <x-slot name="content">
                                <div class="block px-4 py-2 text-xs text-gray-400">
                                    {{ __('Información extra') }}
                                </div>

                                <x-jet-dropdown-link  style="text-decoration: none;" href="{{ route('softskills.index') }}" :active="request()->routeIs('softskills')">
                                    {{ __('Habilidades Blandas') }}
                                </x-jet-dropdown-link>

                                <div class="border-t border-gray-100"></div>

                                <x-jet-dropdown-link  style="text-decoration: none;" href="{{ route('hardskills.index') }}" :active="request()->routeIs('hardskills')">
                                    {{ __('Habilidades Duras') }}
                                </x-jet-dropdown-link>

                                <div class="border-t border-gray-100"></div>

                                <x-jet-dropdown-link  style="text-decoration: none;" href="#">
                                    {{ __('Conocimientos') }}
                                </x-jet-dropdown-link>
                            </x-slot>
                        </x-jet-dropdown>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-evenly h-16">
                <div class="flex">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link style="text-decoration: none;" href="empleos">
                            {{ __('Empleos') }}
                        </x-jet-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link style="text-decoration: none;" href="reports">
                            {{ __('Reportes') }}
                        </x-jet-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link style="text-decoration: none;" href="{{ route('login') }}" :active="request()->routeIs('login')">
                            {{ __('Login') }}
                        </x-jet-nav-link>
                    </div>
                </div>
